...
public:
    ...
    static void zero_centered_rms_norm(const float *weight, const float *input, float *output, size_t n, float eps);
    static void gated_rms_norm(const float *weight, const float *input, const float *gate, float *output, size_t heads, size_t dim, float eps);
