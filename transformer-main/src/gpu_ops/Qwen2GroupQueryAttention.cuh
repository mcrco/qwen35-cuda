...
class Qwen2GroupQueryAttention {
public:
     ...
     */
    explicit Qwen2GroupQueryAttention(int32_t max_seq_len) {}
...
extern template void Qwen2GroupQueryAttention<QWEN2_0_5B>::sdpa<__nv_bfloat16, __nv_bfloat16, __nv_bfloat16, float, float>(
    const __nv_bfloat16*, const __nv_bfloat16*, const __nv_bfloat16*, float*, int32_t, int32_t, cudaStream_t);
extern template void Qwen2GroupQueryAttention<QWEN2_0_5B>::sdpa<float, float, float, float, float>(
