...
#include "Qwen2GroupQueryAttention.cuh"
...
void Qwen2GroupQueryAttention<QWEN2_SIZE>::sdpa(const query_t *queries, const key_t *k_cache, const value_t *v_cache, output_t *weighted_values, int32_t layer_num, int32_t seq_len, cudaStream_t stream) {
...
template<Qwen2Size QWEN2_SIZE>
void Qwen2GroupQueryAttention<QWEN2_SIZE>::sdpa(__nv_bfloat16 *queries, __nv_bfloat16 *k_cache, __nv_bfloat16 *v_cache, float *weighted_values, int32_t layer_num, int32_t seq_len, cudaStream_t stream) {
...
template class Qwen2GroupQueryAttention<QWEN2_0_5B>;

template void Qwen2GroupQueryAttention<QWEN2_0_5B>::sdpa<__nv_bfloat16, __nv_bfloat16, __nv_bfloat16, float, float>(
    const __nv_bfloat16*, const __nv_bfloat16*, const __nv_bfloat16*, float*, int32_t, int32_t, cudaStream_t);
template void Qwen2GroupQueryAttention<QWEN2_0_5B>::sdpa<float, float, float, float, float>(
